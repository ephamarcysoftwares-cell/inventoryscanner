...
class ItDasboard extends StatefulWidget {
  final Map<String, dynamic> user;
  const ItDasboard({super.key, required this.user});

  @override
  _ItDasboardState createState() => _ItDasboardState();
}

class _ItDasboardState extends State<ItDasboard> {
  // Global States
  File? _profileImage;
...
// Helper function ya SnackBar
  ...
  Widget _buildResponsiveGrid(double width, Color cardColor, Color nmbBlue, Color textColor) {
    final Map<String, IconData> modules = {
      ...
      "CONFIGURATION": Icons.settings_suggest_rounded,// More intuitive for CCTV
