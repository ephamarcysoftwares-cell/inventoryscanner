...
// Kwenye State ongeza:
  ...
  Future<List<Map<String, dynamic>>> fetchProducts({String searchQuery = ''}) async {
    try {
      ...
      // 2. Vuta bidhaa (Hakikisha qr_code_url ipo kwenye schema yako ya Supabase)
      var query = supabase
          .from('other_product')
          .select('*') // Tunavuta kila kitu ikiwemo qr_code_url
      ...
      // 5. AUTO QR LOGIC
      // Hii itajaza QR code kwa bidhaa ambazo hazina data kwenye column ya qr_code_url
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              child: Row( // Ondoa 'const' hapa kama ilikuwepo
                children: [
                  Expanded(
                    flex: 3,
                    child: Text(
                      ...
                      softWrap: true, // Inaruhusu kushuka mstari wa pili
                      maxLines: 2,    // Unaweza kusema iishie mistari 2 ili isivuruge urefu wa row
                      overflow: TextOverflow.ellipsis, // Kama ni refu kupitiliza, itaweka ... mwishoni mwa mstari wa pili
                    ),
                  ),
                ...
                builder: (context, snapshot) {
                  ...
                  return ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      // Angalia kama qr_code_url ipo
                      final bool hasQR = p['qr_code_url'] != null && p['qr_code_url'].toString().trim().isNotEmpty;
                              ...
                              Expanded(
                                ...
                                child: Center(
                                  child: hasQR
                                    ...
                                    onPressed: () => _showQRCodeDialog(p), // Hapa inafungua kioo cha QR
                                  )
                                      : const SizedBox(
                                      width: 14,
                                      height: 14,
