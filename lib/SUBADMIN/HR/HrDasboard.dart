...
class HrDasboard extends StatefulWidget {
  final Map<String, dynamic> user;
  const HrDasboard({super.key, required this.user});

  @override
  _HrDasboardState createState() => _HrDasboardState();
}

class _HrDasboardState extends State<HrDasboard> {
  // Global States
  File? _profileImage;
