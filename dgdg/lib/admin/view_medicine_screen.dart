  ...
  Future<List<Map<String, dynamic>>> fetchMedicines({String searchQuery = ''}) async {
    ...
    try {
      ...
      if (response is List) {
        ...
        debugPrint('✅ Fetch Successful: Found ${rawResults.length} items');

        // 🔥 AUTO GENERATE QR CODES AUTOMATICALLY 🔥
        // Tunaita function ya kurekebisha bidhaa ambazo hazina QR Code background
