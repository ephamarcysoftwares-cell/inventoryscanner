...
class OutOfStockNotifier {
  ...
  void start() {
    ...
    void scheduleNextCheck() {
      ...
      // Set next check only at 11:00 PM
      ...
      _timer = Timer(delay, () async {
        ...
        scheduleNextCheck(); // Schedule for next day
      });
    }
  ...
  Future<bool> checkAndSendAvailableStock() async {
    ...
    return await _sendEmail(
      ...
      text: 'Attached is the available stock other  prudct report.',
      attachment: pdfFile,
    );
  }
  ...
  Future<List<Map<String, dynamic>>> getOutOfStockMedicines() async {
    try {
      ...
      print("❌ Error fetching out-of-stock medicines: $e");
      return [];
    }
  }
