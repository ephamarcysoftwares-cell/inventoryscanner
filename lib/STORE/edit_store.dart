...
class _EditMedicineStoreState extends State<EditMedicineStore> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text(widget.medicine != null ? 'Edit Product' : 'Add Product to Store', style: TextStyle(color: Colors.white),),
        ...
        child: Form(
          ...
          child: ListView(
            children: [
              ...
              // Buy Price TextField (with prefix and validation)
              TextFormField(
                controller: _buyController,
                decoration: const InputDecoration(
                  labelText: 'Buy Price (Tsh)',
                  prefixText: 'Tsh ',
                ),
                ...
                validator: (value) {
                  ...
                  if (val == null) return 'Enter valid price';
                  if (val <= 0) return 'Buy price must be greater than zero';
                  return null;
                },
                enabled: widget.medicine == null, // disable editing if updating existing product
              ),
