...
import '../../admin/view_other_product.dart';
...
import '../../phamacy/pharmacist_view report.dart';
import '../../profile/ProfileUpdateScreen.dart';
import '../../register_screen.dart';
import '../../whatsapp/reply.dart';
import '../../whatsapp/whatsap.dart';
import '../ACCOUNTANT/SubAdminview_users.dart';
import 'Subadminregister_screen.dart';



class ReceptinistDasboard extends StatefulWidget {
  final Map<String, dynamic> user;
  const ReceptinistDasboard({super.key, required this.user});

  @override
  _ReceptinistDasboardState createState() => _ReceptinistDasboardState();
}

class _ReceptinistDasboardState extends State<ReceptinistDasboard> {
  // Global States
  File? _profileImage;
            ...
            child: ListView(
              ...
              children: [
                ...
                ListTile(
                  ...
                  title: Text("Dashboard-ACCOUNTANT", style: TextStyle(color: textColor)),
