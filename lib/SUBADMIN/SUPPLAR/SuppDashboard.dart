...
class SuppDashboard extends StatefulWidget {
  final Map<String, dynamic> user;
  const SuppDashboard({super.key, required this.user});

  @override
  _SuppDashboardState createState() => _SuppDashboardState();
}

class _SuppDashboardState extends State<SuppDashboard> {
  // Global States
  File? _profileImage;
