...
class SubAdminRegisterScreenSfaff extends StatefulWidget {
  const SubAdminRegisterScreenSfaff({super.key});

  @override
  _SubAdminRegisterScreenSfaffState createState() => _SubAdminRegisterScreenSfaffState();
}

class _SubAdminRegisterScreenSfaffState extends State<SubAdminRegisterScreenSfaff> {
  ...
  final List<Map<String, String>> _roleOptions = [
    ...
    {'value': 'admin', 'label': 'Manager (In Main Branch)'},
    {'value': 'receptionist', 'label': 'Receptionist/Data Crack'},
