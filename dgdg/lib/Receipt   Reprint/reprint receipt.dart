                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Row(
                            children: [
                              Expanded(
                                child: _buildActionBtn(Icons.print, "Print", Colors.blueGrey, () => _printReceipt(receipt)),
                              ),
                              const SizedBox(width: 12),
                              Expanded(
                                child: _sendingEmails.contains(rNum)
                                    ? const Center(child: CircularProgressIndicator(strokeWidth: 2))
                                    : _buildActionBtn(Icons.send_rounded, "Email", primaryPurple, () => _sendEmailWithAttachment(receipt)),
                              ),
                            ],
                          ),
                        ],
