...
import 'Subadminregister_screen.dart';



class SubBranchDasboard extends StatefulWidget {
  final Map<String, dynamic> user;
  const SubBranchDasboard({super.key, required this.user});

  @override
  _SubBranchDasboardState createState() => _SubBranchDasboardState();
}

class _SubBranchDasboardState extends State<SubBranchDasboard> {
  // Global States
  File? _profileImage;
...
// Helper function ya SnackBar
            ...
            child: ListView(
              ...
              children: [
                ...
                ListTile(
                  ...
                  title: Text("Dashboard-SUB BRANCH(TAWI)", style: TextStyle(color: textColor)),
  ...
  void _handleNavigation(String option) {
    ...
    if (option == "Add Normal Stock") {
      ...
      Navigator.push(
          context, MaterialPageRoute(builder: (_) => SubAdminViewUsersScreen()));
    } else if (option == "Register staff") {
      Navigator.push(
          context, MaterialPageRoute(builder: (_) => SubBranchRegisterScreenSfaff()));
    ...
    //   Navigator.push(context, MaterialPageRoute(builder: (_) =>
    //       RevirseTrasaction(userRole: user['role'] ?? '',
    //           userName: user['username'] ?? user['full_name'] ?? '')));
  ...
  void _openServiceMenu(String module) {
    ...
    switch (module.toUpperCase()) {
      ...
      case "BUSINESS":
        ...
        break;
      case "STORE":
        opts = ["add to store", "view store",  "Store value"];
        break;
      case "CCTV":
