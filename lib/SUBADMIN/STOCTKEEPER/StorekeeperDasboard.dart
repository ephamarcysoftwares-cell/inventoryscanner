...
class StoKeeperDashbord extends StatefulWidget {
  final Map<String, dynamic> user;
  const StoKeeperDashbord({super.key, required this.user});

  @override
  _StoKeeperDashbordState createState() => _StoKeeperDashbordState();
}

class _StoKeeperDashbordState extends State<StoKeeperDashbord> {
  // Global States
  File? _profileImage;
...
// Helper function ya SnackBar
  ...
  void _openServiceMenu(String module) {
    ...
    switch (module.toUpperCase()) {
      case "STOCK":
        opts = [ "View other product", "View Normal Stock", "View Expired Product", ];
        break;
      case "SALES":
